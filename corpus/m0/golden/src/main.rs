...
async fn main() -> Result<(), LanMainError> {
    ...
    lan_print_model_546f646f(&value)?;
    Ok(())
}
...
fn lan_print_model_546f646f(value: &T70726f64756374286e61742c6e6f6d696e616c28353a4279746573292c73756d28756e69742c756e69742929) -> Result<(), LanMainError> {
    let line = format!("Todo {{ id: {}, title: {:?}, completed: {} }}\n", lan_model_to_i64(&value.f0)?, lan_model_text_to_4279746573(&value.f1)?, match &value.f2 { T73756d28756e69742c756e697429::V0(()) => false, T73756d28756e69742c756e697429::V1(()) => true });
