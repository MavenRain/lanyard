...
def main():
    ...
    require(legacy.returncode == 0 and legacy.stderr == ""
            and legacy.stdout.splitlines() == [
                ...
                "Model_get_by_id", "Model_delete_by_id", "topcoat_db", "topcoat_see_other",
                "Todo_create", "Todo_get_by_id", "Todo_delete_by_id"],
