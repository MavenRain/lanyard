...
def main():
    ...
    require(legacy.returncode == 0 and legacy.stderr == ""
            and legacy.stdout.splitlines() == [
                ...
                "Text_trim", "Text_trim_start", "Text_trim_end", "Text_is_empty", "Text_equal", "Text_contains", "Text_starts_with", "Text_ends_with", "Text_replace", "Text_repeat", "Text_length", "Text_concat", "Text_from_nat", "Text_to_nat", "Uri_from_text", "Uri_to_text", "Uri_path", "Uri_query", "Form_field", "Form_has", "Response_text",
