...
def main():
    ...
    require(legacy.returncode == 0 and legacy.stderr == ""
            and legacy.stdout.splitlines() == [
                ...
                "Text_trim", "Text_is_empty", "Text_equal", "Text_concat", "Text_from_nat", "Text_to_nat", "Uri_from_text", "Uri_to_text", "Form_field", "Response_text",
