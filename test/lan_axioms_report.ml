...
let cases = [
  "partial marker", partial,
    [ "Div main : Nat"; "COUNT Div=1"; "AXIOMS total=29";
      "AXIOM-RATIO constants=27 definitions=0 status=REPORTED" ];
  "primitive exclusion", primitives,
    [ "COUNT Div=0"; "AXIOMS total=28";
      "AXIOM-RATIO constants=27 definitions=1 status=REPORTED" ];
]
