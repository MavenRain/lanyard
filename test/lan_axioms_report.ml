...
let cases = [
  "partial marker", partial,
    [ "Div main : Nat"; "COUNT Div=1"; "AXIOMS total=20";
      "AXIOM-RATIO constants=18 definitions=0 status=REPORTED" ];
  "primitive exclusion", primitives,
    [ "COUNT Div=0"; "AXIOMS total=19";
      "AXIOM-RATIO constants=18 definitions=1 status=REPORTED" ];
]
