...
let cases = [
  "partial marker", partial,
    [ "Div main : Nat"; "COUNT Div=1"; "AXIOMS total=27";
      "AXIOM-RATIO constants=25 definitions=0 status=REPORTED" ];
  "primitive exclusion", primitives,
    [ "COUNT Div=0"; "AXIOMS total=26";
      "AXIOM-RATIO constants=25 definitions=1 status=REPORTED" ];
]
