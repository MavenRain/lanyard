...
The [M1 ASCII case adapters](dev/STAGE-M1-TEXT-ASCII.md) add
`Text.to_ascii_lowercase` and `Text.to_ascii_uppercase`. They convert ASCII
letters while preserving non-ASCII text, whitespace, NULs and punctuation.
Both validate the complete input and evaluate it once.
...
Todo reports 48 foreign constants and 3 definitions of the checked
