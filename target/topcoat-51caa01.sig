...
{"name":"Text.to_ascii_lowercase","type":"(0 Text : Type 0) -> (text : Text) -> Text","quantities":["0","w"],"effects":[],"print":"#{text}.to_ascii_lowercase()","kind":"schema","status":"PROPOSED"}
{"name":"Text.to_ascii_uppercase","type":"(0 Text : Type 0) -> (text : Text) -> Text","quantities":["0","w"],"effects":[],"print":"#{text}.to_ascii_uppercase()","kind":"schema","status":"PROPOSED"}
