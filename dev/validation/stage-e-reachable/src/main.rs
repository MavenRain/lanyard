...
#[derive(Clone, Debug, PartialEq, Eq)]
struct T70726f64756374286e617429 { f0: Nat }

#[derive(Clone, Debug, PartialEq, Eq)]
struct T70726f647563742870726f64756374286e6174292c70726f64756374286e61742929 { f0: T70726f64756374286e617429, f1: T70726f64756374286e617429 }
...
async fn f_636f6e6e656374(a0: Arc<T6e6f6d696e616c28353a427974657329>) -> Result<toasty::Db, Error> {
    Ok({ let __lan_url_arg = Arc::clone(&(a0)); let __lan_url = lan_model_text_to_4279746573(&__lan_url_arg)?; toasty::Db::builder().models(toasty::models!(LanModel4669727374, LanModel5365636f6e64, LanModel536368656d614f6e6c79)).connect(&__lan_url).await? })
}

async fn f_6d61696e() -> Result<T70726f647563742870726f64756374286e6174292c70726f64756374286e61742929, Error> {
    Ok({ let v0 = Arc::new(f_636f6e6e656374(Arc::new(T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("115")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("113")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("108")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("105")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("116")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("101")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("58")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("58")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("109")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("101")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("109")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("111")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("114")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("121")?, T6e6f6d696e616c28353a427974657329::V1(Box::new((Nat::decimal("58")?, T6e6f6d696e616c28353a427974657329::V0,))),))),))),))),))),))),))),))),))),))),))),))),))),))),))))).await?); { let v1 = { let __lan_arg_0 = Arc::clone(&(v0)); (&*(__lan_arg_0)).push_schema().await? }; { let v2 = { let __lan_value = Arc::new(T70726f64756374286e617429 { f0: Nat::decimal("1")? }); let __lan_db_arg = Arc::clone(&(v0)); let mut __lan_db = (*__lan_db_arg).clone(); let __lan_row = toasty::create!(LanModel4669727374 { id: lan_model_to_i64(&__lan_value.f0)? }).exec(&mut __lan_db).await?; T70726f64756374286e617429 { f0: lan_model_from_i64(__lan_row.id)? } }; { let v3 = { let __lan_value = Arc::new(T70726f64756374286e617429 { f0: Nat::decimal("1")? }); let __lan_db_arg = Arc::clone(&(v0)); let mut __lan_db = (*__lan_db_arg).clone(); let __lan_row = toasty::create!(LanModel5365636f6e64 { id: lan_model_to_i64(&__lan_value.f0)? }).exec(&mut __lan_db).await?; T70726f64756374286e617429 { f0: lan_model_from_i64(__lan_row.id)? } }; T70726f647563742870726f64756374286e6174292c70726f64756374286e61742929 { f0: { let __lan_value = Arc::new(Nat::decimal("1")?); let __lan_db_arg = Arc::clone(&(v0)); let mut __lan_db = (*__lan_db_arg).clone(); let __lan_row = LanModel4669727374::get_by_id(&mut __lan_db, &lan_model_to_i64(&__lan_value)?).await?; T70726f64756374286e617429 { f0: lan_model_from_i64(__lan_row.id)? } }, f1: { let __lan_value = Arc::new(Nat::decimal("1")?); let __lan_db_arg = Arc::clone(&(v0)); let mut __lan_db = (*__lan_db_arg).clone(); let __lan_row = LanModel5365636f6e64::get_by_id(&mut __lan_db, &lan_model_to_i64(&__lan_value)?).await?; T70726f64756374286e617429 { f0: lan_model_from_i64(__lan_row.id)? } } } } } } })
}
...
struct LanModel4669727374 {
    #[key]
    id: i64,
}

#[derive(Debug, toasty::Model)]
struct LanModel5365636f6e64 {
    #[key]
    id: i64,
}

#[derive(Debug, toasty::Model)]
struct LanModel536368656d614f6e6c79 {
    #[key]
    id: i64,
}
