...
#   zsh dev/gates.sh --stage M1-native-session
#   zsh dev/gates.sh --stage M1-http
...
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-text-ascii" ]]; then
  exec zsh ${0:A:h}/stage-m1-text-ascii.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-text-trim" ]]; then
  exec zsh ${0:A:h}/stage-m1-text-trim.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-text-repeat" ]]; then
  exec zsh ${0:A:h}/stage-m1-text-repeat.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-text-replace" ]]; then
  exec zsh ${0:A:h}/stage-m1-text-replace.sh
fi
...
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-text-length" ]]; then
  exec zsh ${0:A:h}/stage-m1-text-length.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-form-has" ]]; then
  exec zsh ${0:A:h}/stage-m1-form-has.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-uri-parts" ]]; then
  exec zsh ${0:A:h}/stage-m1-uri-parts.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-database" ]]; then
  exec zsh ${0:A:h}/stage-m1-database.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-serve" ]]; then
  exec zsh ${0:A:h}/stage-m1-serve.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-http" ]]; then
  exec zsh ${0:A:h}/stage-m1-http.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-native-session" ]]; then
  exec zsh ${0:A:h}/stage-m1-native-session.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-session" ]]; then
  exec zsh ${0:A:h}/stage-m1-session.sh
fi

if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-uri-text" ]]; then
  exec zsh ${0:A:h}/stage-m1-uri-text.sh
fi

if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-text-equal" ]]; then
  exec zsh ${0:A:h}/stage-m1-text-equal.sh
fi

if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-text-nat" ]]; then
  exec zsh ${0:A:h}/stage-m1-text-nat.sh
fi

if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-nat-text" ]]; then
  exec zsh ${0:A:h}/stage-m1-nat-text.sh
fi

if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-concat" ]]; then
  exec zsh ${0:A:h}/stage-m1-concat.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-html" ]]; then
  exec zsh ${0:A:h}/stage-m1-html.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-response" ]]; then
  exec zsh ${0:A:h}/stage-m1-response.sh
fi
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-form" ]]; then
  exec zsh ${0:A:h}/stage-m1-form.sh
fi
...
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-all" ]]; then
  exec zsh ${0:A:h}/stage-m1-all.sh
fi

if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-update" ]]; then
  exec zsh ${0:A:h}/stage-m1-update.sh
fi
...
if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-run" ]]; then
  exec zsh ${0:A:h}/stage-m1-run.sh
fi

if [[ $# -eq 2 && $1 == "--stage" && $2 == "M1-build" ]]; then
  exec zsh ${0:A:h}/stage-m1-build.sh
fi
